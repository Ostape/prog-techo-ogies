...
public class CrazyLambdas {
    ...
    /**
     * Returns a {@link BiFunction} that has two parameters. First is {@link IntUnaryOperator} which is some
     * integer function.
    ...
    public static BiFunction<IntUnaryOperator, IntPredicate, IntUnaryOperator> functionToConditionalFunction() {
        return (integerFunction, intCondition) -> unaryOperator ->
                intCondition.test(unaryOperator) ? integerFunction.applyAsInt(unaryOperator) : unaryOperator;
    }
